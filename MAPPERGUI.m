...
if doStitch
    ...
    javaaddpath('C:\Users\james\SSD Documents\MAPPER\jar\ij.jar')
    javaaddpath('C:\Users\james\SSD Documents\MAPPER\jar\mij.jar')
        ...
        for j = 1:length(channels)
            ...
            elseif filterchoice == 3
                for i = 1:25
                    ...
                    if i == 1
                        imwrite(IFFT, savepath2)
                    elseif i > 1
                        imwrite(IFFT,savepath2,'writemode','append')
                    end
                end
                MIJ.run('Open...', ['path=[' strrep(savepath2, '\', '\\') ']']);
            end
